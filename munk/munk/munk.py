...
def embed_networks(source_G, target_G, homologs, n_landmarks,
    ...
    '''
    Computes MUNK embeddings of given source and target graphs with given
    ...
    :param n_landmarks: The number of landmarks to use for MUNK embedding
    :param lam: lambda value for regularized laplacian

    :return: MUNK embeddings for source and target species
    '''
