...
def munk_embed_wrapper(source_data,
                        target_data,
                        homologs,
                        n_landmarks,
                        ref_source_nodes,
    ...
    source_C, target_C_hat = munk.embed_matrices(source_C, target_D, landmark_idxs)
...
def dissim_diff(sim_scores, landmark_idxs, homolog_idxs):
    ...
    #    munk.separate_scores(dissim_scores, landmark_idxs, homolog_idxs)
    _,_,_, hom_hom_scores, other_scores = \
        munk.separate_scores(sim_scores, landmark_idxs, homolog_idxs)
...
def difference_in_means(source_data,
                        ...
                        ref_source_nodes,
                        ref_target_nodes):
    munk_results = munk_embed_wrapper(source_data,
                                        target_data,
                                        homologs,
                                        n_landmarks,
                                        ref_source_nodes,
                                        ref_target_nodes)
    return dissim_diff(*munk_results)
